...
var LatexIT = {
  ...
  //  if(document.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1"))
		  ...
		  if(this.mode=='svg')  
			{
				// Best for Firefox
				if(this.isFirefox) 
  		   	txt = " <object type=\"image/svg+xml\" data=\"http://212.59.241.225/mathtex/mathtex.cgi?"+ txt +"\" class=\"latex\" /> ";
				else // Best for Chrome
  		   //	txt = " <object type=\"image/svg+xml\" data=\"http://latex.codecogs.com/"+this.mode+".latex?"+ txt +"\" class=\"latex\" /> ";
					txt = " <img src=\"http://212.59.241.225/mathtex/mathtex.cgi?"+ txt +"\" alt=\""+ txt +"\" title=\""+ txt +"\" border=\"0\" class=\"latex\" /> ";
			}
			else 
	   	  txt = " <img src=\"http://212.59.241.225/mathtex/mathtex.cgi?"+ txt +"\" alt=\""+txt+"\" border=\"0\" class=\"latex\" /> ";
		}
		return txt;
	},
	...
	latex : function(txt) {
		var html, htmlinline;
		if(this.isFirefox) {
		  html=" <object type=\"image/svg+xml\" data=\"http://212.59.241.225/mathtex/mathtex.cgi?$2\" class=\"latex\" /> ";
		  htmlinline=" <object type=\"image/svg+xml\" data=\"http://212.59.241.225/mathtex/mathtex.cgi?\\inline $2\" class=\"latex\" /> ";
		}
		else {
		  html=" <img src=\"http://212.59.241.225/mathtex/mathtex.cgi?$2\" border=\"0\" class=\"latex\" /> ";
		  htmlinline=" <img src=\"http://212.59.241.225/mathtex/mathtex.cgi?\\inline $2\" border=\"0\" class=\"latex\" /> ";
		}
